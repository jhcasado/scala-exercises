...
developers := List(
  Developer("jhcasado",
            "Javier Casado",
            "jhcasado@kentech-sp.com",
            url("https://github.com/jhcasado")
  )
)
...
scalacOptions in (Compile, doc) ++= baseDirectory.map {
  (bd: File) => Seq[String](
     ...
     "-doc-source-url", "https://github.com/jhcasado/scala-exercises/tree/master€{FILE_PATH}.scala"
  )
}.value
...
scmInfo := Some(
  ScmInfo(
    ...
    s"git@github.com:jhcasado/$name.git"
  )
)
